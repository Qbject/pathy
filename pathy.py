...
class RandGrGenerator():
	def __init__(self):
		...
		self.GRS_FILE_PATH = self.TARG_DIR / "textdata/grs.txt"
		self.GRS_PLUR_FILE_PATH = self.TARG_DIR / "textdata/grs_plur.txt"
		self.MODIFIERS_FILE_PATH = self.TARG_DIR / "textdata/adjectives.txt"
		self.PREFIXES_FILE_PATH = self.TARG_DIR / "textdata/prefixes.txt"
