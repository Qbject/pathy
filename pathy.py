...
class RandGrGenerator():
    def __init__(self):
        ...
        self.GRS_FILE_PATH = self.TARG_DIR / "grs.txt"
        self.GRS_PLUR_FILE_PATH = self.TARG_DIR / "grs_plur.txt"
        self.MODIFIERS_FILE_PATH = self.TARG_DIR / "modifiers.txt"
        self.PREFIXES_FILE_PATH = self.TARG_DIR / "prefixes.txt"
...
class PathyRobot():
    def __init__(self):
        ...
        self.cache_dir = self.cur_dir / "cache"
    ...
    def on_tg_update(self, update):
        ...
        if chat_id == self.DEBUG_CHAT_ID:
            if update["message"]["text"] == "daemon":
                import subprocess
                subprocess.Popen(["python3", "/home/viva88/daemon_test.py"])
                return
